...
<body class="min-h-screen bg-base-200">
    <nav class="sticky top-0 z-50 bg-gray-100 shadow-sm">
        <div class="container flex justify-between mx-auto navbar">
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Search Bar -->
                <div class="flex">
                    <input type="text" placeholder="Pencarian" class="input input-success input-bordered rounded-r-none" />
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <ul
                        ...
                        <li>
                            <a href="/pelanggan/profile" class="justify-between">
                                Profil
                ...
                <div class="flex gap-2">
                    <a class="btn btn-success" href="/register">Registrasi</a>
                    <a class="btn btn-outline btn-success" href="/login">Login</a>
                </div>
                @endauth
            </div>
        </div>
    ...
    <footer class="bg-transparant mt-3 ">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="/src/img/logo.png" class="h-8 me-3" alt="Apotek Baraya Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap ">Apotek Baraya</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center"> © 2025 <a href="#" class=" hover:underline">Apotek Baraya™</a>. All Rights Reserved.
                </span>
