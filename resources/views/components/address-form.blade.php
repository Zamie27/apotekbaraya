...
<div class="space-y-4">
    ...
    <!-- Label Alamat -->
    <div>
        <label for="{{ $wireModel }}.label" class="block text-sm font-medium text-gray-700 mb-1">
    ...
    <!-- Nama Penerima -->
    <div>
        <label for="{{ $wireModel }}.recipient_name" class="block text-sm font-medium text-gray-700 mb-1">
    ...
    <!-- Nomor Telepon -->
    <div>
        <label for="{{ $wireModel }}.phone" class="block text-sm font-medium text-gray-700 mb-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- Provinsi -->
        <div>
            <label for="{{ $wireModel }}.province_key" class="block text-sm font-medium text-gray-700 mb-1">
        ...
        <!-- Kabupaten -->
        <div>
            <label for="{{ $wireModel }}.regency_key" class="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div class="relative">
                ...
                <div wire:loading wire:target="updateRegencies" class="absolute right-3 top-1/2 transform -translate-y-1/2">
        ...
        <!-- Kecamatan -->
        <div>
            <label for="{{ $wireModel }}.sub_district_key" class="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div class="relative">
                ...
                <div wire:loading wire:target="updateSubDistricts" class="absolute right-3 top-1/2 transform -translate-y-1/2">
                    <svg class="animate-spin h-4 w-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
        ...
        <!-- Desa -->
        <div>
            <label for="{{ $wireModel }}.village_key" class="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div class="relative">
                ...
                <div wire:loading wire:target="updateVillages" class="absolute right-3 top-1/2 transform -translate-y-1/2">
                    <svg class="animate-spin h-4 w-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
    ...
    <!-- Kode Pos -->
    <div>
        <label for="{{ $wireModel }}.postal_code" class="block text-sm font-medium text-gray-700 mb-1">
        ...
        <div class="relative">
            ...
            <div wire:loading wire:target="updatePostalCodes" class="absolute right-3 top-1/2 transform -translate-y-1/2">
                <svg class="animate-spin h-4 w-4 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
    ...
    <!-- Detail Alamat -->
    <div>
        <label for="{{ $wireModel }}.detailed_address" class="block text-sm font-medium text-gray-700 mb-1">
    ...
    <!-- Catatan -->
    <div>
        <label for="{{ $wireModel }}.notes" class="block text-sm font-medium text-gray-700 mb-1">
            Catatan (Opsional)
        </label>
    ...
    <div class="flex items-center">
        ...
        <label for="{{ $wireModel }}.is_default" class="ml-2 block text-sm text-gray-700">
