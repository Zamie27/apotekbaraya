    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card bg-base-100 shadow-lg">
                    <div class="card-body">
                        <h3 class="text-lg font-semibold mb-4">Barang yang Dipesan</h3>
                        <div class="space-y-3">
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">{{ $item->formatted_price }} × {{ $item->quantity }}</p>
                                        </div>
                                    </div>
                            ...
                            <div class="border-t pt-3 mt-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-lg text-primary">{{ $delivery->order->formatted_total }}</span>
                                </div>
                                @if($delivery->order->delivery_fee > 0)
                                    <div class="flex justify-between items-center text-sm text-gray-600 mt-1">
                                        <span>Ongkos Kirim:</span>
                                        <span>{{ $delivery->order->formatted_delivery_fee }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
