        ...
        <div class="modal modal-open">
            <div class="modal-box w-11/12 max-w-4xl">
                <form wire:submit.prevent="createUser">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="form-control">
                                    ...
                                    <div class="relative">
                                        <input type="password" wire:model="password" class="input input-bordered focus:input-primary @error('password') input-error @enderror" placeholder="Masukkan password">
                                ...
                                <div class="form-control">
                                    ...
                                    <div class="relative">
                                        <input type="password" wire:model="password_confirmation" class="input input-bordered focus:input-primary @error('password_confirmation') input-error @enderror" placeholder="Konfirmasi password">
                                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                ...
                                <div class="form-control">
                                    ...
                                    <select wire:model="role_id" class="select select-bordered focus:select-primary @error('role_id') select-error @enderror">
                    ...
                    <!-- Footer -->
                    <div class="flex justify-end space-x-3 mt-8 pt-6 border-t border-base-300">
