    ...
    <div class="card bg-base-100 shadow">
        <div class="card-body space-y-4">
            ...
            <div>
                ...
                <div class="text-sm opacity-70 mt-1">Gunakan JSON valid. Import CSV menggunakan header: kandungan, kemasan, produsen, komposisi, manfaat, dosis, efek_samping, lainnya.</div>
